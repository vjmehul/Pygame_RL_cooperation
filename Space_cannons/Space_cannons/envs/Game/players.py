...
class Gameplayer1(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load(r'C:/Users/Shizu/Desktop/Pygame_RL/Pygame_RL_cooperation/Space_cannons/Space_cannons/envs/Game_imgs/player1.png').convert_alpha()
...
class Gameplayer2(pygame.sprite.Sprite):
    ...
    def __init__(self):
        ...
        self.image = pygame.image.load(r'C:/Users/Shizu/Desktop/Pygame_RL/Pygame_RL_cooperation/Space_cannons/Space_cannons/envs/Game_imgs/player2.png').convert_alpha()
        self.image = pygame.transform.scale(self.image, (60,1100))
        self.rect = self.image.get_rect()
