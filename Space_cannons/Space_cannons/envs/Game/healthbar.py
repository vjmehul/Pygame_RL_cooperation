...
class healthbar(pygame.sprite.Sprite):
    def __init__(self,hp):
        ...
        self.max_hp = hp
        self.hp = self.max_hp
        self.original_image = pygame.image.load(r'C:/Users/Shizu/Desktop/Pygame_RL/Pygame_RL_cooperation/Space_cannons/Space_cannons/envs/Game_imgs/healthbar.png').convert_alpha()
