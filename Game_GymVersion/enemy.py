...
import random
from players import Gameplayer1, Gameplayer2
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.image = pygame.image.load(weak_enemy_list[rannum]).convert_alpha()
        ...
        self.img_b_explosion_01 = pygame.image.load('blue_explosion/blue-explosion-1.png').convert_alpha()
        self.img_b_explosion_01 = pygame.transform.scale(self.img_b_explosion_01, (100, 100))

        self.img_b_explosion_02 = pygame.image.load('blue_explosion/blue-explosion-2.png').convert_alpha()
        self.img_b_explosion_02 = pygame.transform.scale(self.img_b_explosion_02, (100, 100))

        self.img_b_explosion_03 = pygame.image.load('blue_explosion/blue-explosion-3.png').convert_alpha()
        self.img_b_explosion_03 = pygame.transform.scale(self.img_b_explosion_03, (100, 100))

        self.img_b_explosion_04 = pygame.image.load('blue_explosion/blue-explosion-4.png').convert_alpha()
        self.img_b_explosion_04 = pygame.transform.scale(self.img_b_explosion_04, (100, 100))

        self.img_b_explosion_05 = pygame.image.load('blue_explosion/blue-explosion-5.png').convert_alpha()
        self.img_b_explosion_05 = pygame.transform.scale(self.img_b_explosion_05, (100, 100))

        self.img_b_explosion_06 = pygame.image.load('blue_explosion/blue-explosion-6.png').convert_alpha()
